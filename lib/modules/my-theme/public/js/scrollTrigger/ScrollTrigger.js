...
(function (root, factory) {
	...
	return function(defaultOptions, bindTo, scrollIn) {
		...
		var Trigger = function(_defaultOptions, _element) {
			...
			this.width = function(_this) {
				return function(){
					...
					// if (_this.element.offsetWidth >windowWidth){
					// 	console.log(WWW);
			...
			this.height = function(_this) {
				return function(){
					...
					// if (_this.element.offsetHeight >windowHeight){
					// 	console.log(HHH);
		...
		var loop =  window.requestAnimationFrame ||
			...
			function(callback){ setTimeout(callback, 1000 / 60); }; // was 60
		...
		function update() {
			...
			//console.log(_this.bindElement.scrollTop,document.documentElement.scrollTop)
...
//console.log('triggerLeft '+triggerLeft+' windowWidth '+windowWidth)
					// toggle the classes
				
					//if (triggerLeft < windowWidth && triggerLeft >= 0 &&
					//	triggerTop < windowHeight && triggerTop >= 0) {
							if (triggerLeft < windowWidth  &&
								triggerTop < windowHeight && triggerTop >= 0) {
