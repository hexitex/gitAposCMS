apos.define('quote-request-form-widgets' , {
    ...
    construct : function(self,options){
        self.play = function($widget , data , options){
            ...
            var schema = self.options.submitContact;
            ...
            function submit() {
                ...
                function submitToServer(callback) {
                    ...
                    piece.telephone = $('input[name="telephone"]').val();
                    ...
                    piece.address = $('textarea[name="address"]').val();
                   
                    return self.api('contact', piece, function (data) {
