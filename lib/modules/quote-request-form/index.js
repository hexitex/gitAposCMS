...
module.exports = {
  ...
  construct: function (self, options) {
    ...
    self.afterInsert = function (req, piece, options, callback) {
      ...
      var img1 = self.apos.attachments.url(piece.image1, { size: '720', edit: false })
      var img2 = self.apos.attachments.url(piece.image2, { size: '720', edit: false })
      var img3 = self.apos.attachments.url(piece.image3, { size: '720', edit: false })
      var img4 = self.apos.attachments.url(piece.image4, { size: '720', edit: false })
      var img5 = self.apos.attachments.url(piece.image5, { size: '720', edit: false })
      var img6 = self.apos.attachments.url(piece.image6, { size: '720', edit: false })
      var img7 = self.apos.attachments.url(piece.image7, { size: '720', edit: false })
      var img8 = self.apos.attachments.url(piece.image8, { size: '720', edit: false })
      var img9 = self.apos.attachments.url(piece.image9, { size: '720', edit: false })
      var img10 = self.apos.attachments.url(piece.image10, { size: '720', edit: false })
