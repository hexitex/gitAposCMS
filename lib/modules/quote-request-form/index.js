...
module.exports = {
  ...
  construct: function (self, options) {
    ...
    self.afterInsert = function (req, piece, options, callback) {
      ...
      var img1 = self.apos.attachments.url(piece.image1, { size: '720p', edit: false })
      var img2 = self.apos.attachments.url(piece.image2, { size: '720p', edit: false })
      var img3 = self.apos.attachments.url(piece.image3, { size: '720p', edit: false })
      var img4 = self.apos.attachments.url(piece.image4, { size: '720p', edit: false })
      var img5 = self.apos.attachments.url(piece.image5, { size: '720p', edit: false })
      var img6 = self.apos.attachments.url(piece.image6, { size: '720p', edit: false })
      var img7 = self.apos.attachments.url(piece.image7, { size: '720p', edit: false })
      var img8 = self.apos.attachments.url(piece.image8, { size: '720p', edit: false })
      var img9 = self.apos.attachments.url(piece.image9, { size: '720p', edit: false })
      var img10 = self.apos.attachments.url(piece.image10, { size: '720p', edit: false })
      ...
      var htmlfooter = '<p>Warmest Regards</p><p>' + process.env.CONAME + ' - ' + process.env.CONUMBER + '</p></div></body>'
      ...
      piece.image1 ? htmltable += '<tr><td colspan="2" style="padding:15px;width:100%;text-align:center;border:0">Photo 1(med quality)</td></tr><tr><td align="center" colspan="2" style="border:1px solid #ffa600;padding:5px"><img style="width:70%;max-width:70%" src="' + hosty + img1 + '"/></td></tr>' : htmltable += '';
      piece.image2 ? htmltable += '<tr><td colspan="2" style="padding:15px;width:100%;text-align:center;border:0">Photo 2(med quality)</td></tr><tr><td align="center" colspan="2" style="border:1px solid #ffa600;padding:5px"><img style="width:70%;max-width:70%" src="' + hosty + img2 + '"/></td></tr>' : htmltable += '';
      piece.image3 ? htmltable += '<tr><td colspan="2" style="padding:15px;width:100%;text-align:center;border:0">Photo 3(med quality)</td></tr><tr><td align="center" colspan="2" style="border:1px solid #ffa600;padding:5px"><img style="width:70%;max-width:70%" src="' + hosty + img3 + '"/></td></tr>' : htmltable += '';
      piece.image4 ? htmltable += '<tr><td colspan="2" style="padding:15px;width:100%;text-align:center;border:0">Photo 4(med quality)</td></tr><tr><td align="center" colspan="2" style="border:1px solid #ffa600;padding:5px"><img style="width:70%;max-width:70%"src="' + hosty + img4 + '"/></td></tr>' : htmltable += '';
      piece.image5 ? htmltable += '<tr><td colspan="2" style="padding:15px;width:100%;text-align:center;border:0">Photo 5(med quality)</td></tr><tr><td align="center" colspan="2" style="border:1px solid #ffa600;padding:5px"><img style="width:70%;max-width:70%" src="' + hosty + img5 + '"/></td></tr>' : htmltable += '';
      piece.image6 ? htmltable += '<tr><td colspan="2" style="padding:15px;width:100%;text-align:center;border:0">Photo 6(med quality)</td></tr><tr><td align="center" colspan="2" style="border:1px solid #ffa600;padding:5px"><img style="width:70%;max-width:70%" src="' + hosty + img6 + '"/></td></tr>' : htmltable += '';
      piece.image7 ? htmltable += '<tr><td colspan="2" style="padding:15px;width:100%;text-align:center;border:0">Photo 7(med quality)</td></tr><tr><td align="center" colspan="2" style="border:1px solid #ffa600;padding:5px"><img style="width:70%;max-width:70%" src="' + hosty + img7 + '"/></td></tr>' : htmltable += '';
      piece.image8 ? htmltable += '<tr><td colspan="2" style="padding:15px;width:100%;text-align:center;border:0">Photo 8(med quality)</td></tr><tr><td align="center" colspan="2" style="border:1px solid #ffa600;padding:5px"><img style="width:70%;max-width:70%" src="' + hosty + img8 + '"/></td></tr>' : htmltable += '';
      piece.image9 ? htmltable += '<tr><td colspan="2" style="padding:15px;width:100%;text-align:center;border:0">Photo 9(med quality)</td></tr><tr><td align="center" colspan="2" style="border:1px solid #ffa600;padding:5px"><img style="width:70%;max-width:70%" src="' + hosty + img9 + '"/></td></tr>' : htmltable += '';
      piece.image10 ? htmltable += '<tr><td colspan="2" style="padding:15px;width:100%;text-align:center;border:0">Photo 10(med quality)</td></tr><tr><td align="center" colspan="2" style="border:1px solid #ffa600;padding:5px"><img style="width:70%;max-width:70%" src="' + hosty + img10 + '"/></td></tr>' : htmltable += '';
