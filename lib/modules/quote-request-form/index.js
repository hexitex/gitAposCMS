...
//var hosty='driscolplasters.co.uk'
...
function getTitle(){
  return getNumberDate()+Math.random(1000)+Math.random(1000);
}
...
module.exports = {        
  ...
  labelShow:false},
        ...
        
       {
           ...
           placeholder : 'Anything else you want to ask or tell? Examples might be: I have a loose tiles to be fixed. or Leaking Mixer Taps to repair, etc',
           labelShow : true,
           textarea : true
       },
       {
        ...
        },
       {
        ...
        label: 'Photo 1',
        group: 'images',
        help:'Adding photos is optional, but it will really help us to understand the condition of the work area, tile surfaces, etc.',
        widgetControls: true
      },
      {
        type: 'attachment',
   ...
   construct : function(self,options){
    ...
    self.afterInsert = function(req, piece, options, callback) {
      ...
      +'<img src="'+hosty+'/assets/img/logo.png" border="0" style="width:50%"/></td></tr></table>'
    ...
    var info = transporter.sendMail({
      from: '"'+process.env.CONAME+'" <'+process.env.COEMAIL+'>', // sender address
