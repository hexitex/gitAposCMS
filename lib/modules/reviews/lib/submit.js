        ...
        function insert(callback) {
           ...
           // console.trace()
            var piece = {
                ...
                reviews: filter.clean(self.apos.launder.string(req.body.reviews)),
                ratings:self.apos.launder.integer(req.body.ratings),
                productId: self.apos.launder.id(req.body.productId),
