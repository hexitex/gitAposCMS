...
module.exports = {        
   ...
   construct : function(self,options){
    ...
    self.afterInsert = function(req, piece, options, callback) {
        ...
        var htmlfooter='<p>Warmest Regards</p><p>'+nam+'</p><p>Please do not reply to this message, this is an Admin account only - we will reply seperately if needed</p></div></body>'
        ...
        try {
          ...
          var info = transporter.sendMail({
            ...
            subject: "Your Messages has been received ✔", // Subject line
